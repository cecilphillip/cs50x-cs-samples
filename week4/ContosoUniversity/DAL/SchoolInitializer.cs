...
namespace ContosoUniversity.DAL
{
    public class SchoolInitializer : System.Data.Entity.DropCreateDatabaseAlways<SchoolContext>
    {
        protected override void Seed(SchoolContext context)
        {
            ...
            {
            new Department{ Name = "Biology", StartDate = DateTime.Parse("2015-09-01")},
            new Department{ Name = "Engineering",StartDate = DateTime.Parse("2015-09-01")},
            new Department{ Name = "English", StartDate = DateTime.Parse("2015-09-01")}
            };
